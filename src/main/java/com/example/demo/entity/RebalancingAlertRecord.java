...
public class RebalancingAlertRecord {
    ...
    public RebalancingAlertRecord(Long id, Long investorId, AssetClassType assetClass, Double currentPercentage, Double targetPercentage, AlertSeverity severity, String message, LocalDateTime createdAt, Boolean resolved) {
        this.id = id;
